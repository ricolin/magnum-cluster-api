...
## [0.26.3](https://github.com/ricolin/magnum-cluster-api/compare/v0.29.3...v0.26.3) (2025-04-10)


### Features

* add 1.27 support ([c256e74](https://github.com/ricolin/magnum-cluster-api/commit/c256e74c4f76153b30fdaee68b92750a2e140d2f))
* Add aarch64 builds ([#508](https://github.com/ricolin/magnum-cluster-api/issues/508)) ([11300c6](https://github.com/ricolin/magnum-cluster-api/commit/11300c6f203b511693482c3bf6fe506136952d86))
* add autoscale from zero ([#530](https://github.com/ricolin/magnum-cluster-api/issues/530)) ([36d6776](https://github.com/ricolin/magnum-cluster-api/commit/36d6776ed8ffbe378a0734ec39775ba2d571d89c))
* add cluster-autoscaler ([cf05ce5](https://github.com/ricolin/magnum-cluster-api/commit/cf05ce5f463b0f32794ca7047b46eb48796486f3))
* Add labels for nodegroup name and role name ([bfc2f52](https://github.com/ricolin/magnum-cluster-api/commit/bfc2f5228bdc6e137918c8ee721b20a689d24f95))
* add m-capi-proxy ([a699349](https://github.com/ricolin/magnum-cluster-api/commit/a699349f61d3db0d1d81fe5a94fd8b5fdaa6db12))
* Add manila csi ([fceabed](https://github.com/ricolin/magnum-cluster-api/commit/fceabedb2e8913b8bff858073f6eb532c4d93dc3))
* add tolerations for csi controllerPlugin manifests ([#533](https://github.com/ricolin/magnum-cluster-api/issues/533)) ([c991d55](https://github.com/ricolin/magnum-cluster-api/commit/c991d552006ef44b60c2b026554cf7e45e5d459b))
* Allow odd number of master count only ([c6488c7](https://github.com/ricolin/magnum-cluster-api/commit/c6488c7c3cb0bf494d705b487d74bc76bb1ccdf0))
* allow ovn lbs ([#348](https://github.com/ricolin/magnum-cluster-api/issues/348)) ([80efca9](https://github.com/ricolin/magnum-cluster-api/commit/80efca982ca979ee947bcc84ff37407f986a30d3))
* Automatically rotating certificates using Kubeadm Control Plane provider ([#361](https://github.com/ricolin/magnum-cluster-api/issues/361)) ([9e4bed1](https://github.com/ricolin/magnum-cluster-api/commit/9e4bed1d328e29cfaf43635978f6da4688768856))
* Eliminate flux dependency for cluster autoscaler ([3276d9a](https://github.com/ricolin/magnum-cluster-api/commit/3276d9ace559bfc585c211292f584a8cfdef8a08))
* enable in-cluster traffic ([61bf7aa](https://github.com/ricolin/magnum-cluster-api/commit/61bf7aa3bf1990eb0c067d4272b28305ea8eb155))
* enable octavia_lb_algorithm label ([#358](https://github.com/ricolin/magnum-cluster-api/issues/358)) ([bd339ee](https://github.com/ricolin/magnum-cluster-api/commit/bd339eefa43f88e91281c7c3a132ed8c7bd313e2)), closes [#355](https://github.com/ricolin/magnum-cluster-api/issues/355)
* Expose underlying k8s resource status to coe cluster status reason ([cd0438a](https://github.com/ricolin/magnum-cluster-api/commit/cd0438a30331383771d8e687408130ce33d54610))
* Fetch node count from md object when autoscaling enabled ([d64ca86](https://github.com/ricolin/magnum-cluster-api/commit/d64ca8637da2e181143f3156a07b0ca3abe10e97))
* Migrate ClusterClass & friends to Rust ([#519](https://github.com/ricolin/magnum-cluster-api/issues/519)) ([d586a38](https://github.com/ricolin/magnum-cluster-api/commit/d586a38a27534cf7438018c712c0aec57311ced7))
* RockyLinux 8/9 support ([#326](https://github.com/ricolin/magnum-cluster-api/issues/326)) ([2a53f3e](https://github.com/ricolin/magnum-cluster-api/commit/2a53f3e340524deee3ddbf08b41071fba070d7d3))
* set disableAPIServerFloatingIP as optional boolean ([#486](https://github.com/ricolin/magnum-cluster-api/issues/486)) ([0b0295b](https://github.com/ricolin/magnum-cluster-api/commit/0b0295b431899dfa848601444cf87986061fb0b4))
* support additional cert sans [ATMOSPHERE-260] ([#402](https://github.com/ricolin/magnum-cluster-api/issues/402)) ([da93f6a](https://github.com/ricolin/magnum-cluster-api/commit/da93f6abc822579d52d88eace644c7d9bd0a8cdd))
* support cilium cni ([#287](https://github.com/ricolin/magnum-cluster-api/issues/287)) ([4f922d0](https://github.com/ricolin/magnum-cluster-api/commit/4f922d0a805cea8a4b0e6e520b28d81a55b5e150))
* support docker volume type and size ([#370](https://github.com/ricolin/magnum-cluster-api/issues/370)) ([5360349](https://github.com/ricolin/magnum-cluster-api/commit/5360349333aa52b934b8f5cc37df859064dfed48))
* Support endpoint configuration for cluster-api ([#211](https://github.com/ricolin/magnum-cluster-api/issues/211)) ([8a5ffac](https://github.com/ricolin/magnum-cluster-api/commit/8a5ffac1e0ed3f1a7166dfd15a62b74f6a140963))
* support etcd volume ([#305](https://github.com/ricolin/magnum-cluster-api/issues/305)) ([544cb77](https://github.com/ricolin/magnum-cluster-api/commit/544cb77a4a2101dc2af6ee940ab05968f015fc1a))
* Support Flatcar OS ([#225](https://github.com/ricolin/magnum-cluster-api/issues/225)) ([ef4401f](https://github.com/ricolin/magnum-cluster-api/commit/ef4401f3019d04735c0ee85e4b8057896086c70a))
* support keystone-auth ([#297](https://github.com/ricolin/magnum-cluster-api/issues/297)) ([50a2c27](https://github.com/ricolin/magnum-cluster-api/commit/50a2c277be084fefcc7a53c9309716771c003ea8))
* support multiple control plane availability zones ([#320](https://github.com/ricolin/magnum-cluster-api/issues/320)) ([8ceb19a](https://github.com/ricolin/magnum-cluster-api/commit/8ceb19accf272c708bc09ed3340aa45c9ac54253))
* Support OpenID Connect for kube-api auth ([0a33863](https://github.com/ricolin/magnum-cluster-api/commit/0a338631793ec8ae6494a5453b5c332ad9ff0094))
* Support tls-cipher-suite configuration for kubelet ([5010c9a](https://github.com/ricolin/magnum-cluster-api/commit/5010c9a4dd2c2656089b5807c38d95aec8c6ef0a))
* support virtio-scsi model ([#529](https://github.com/ricolin/magnum-cluster-api/issues/529)) ([b1fb72b](https://github.com/ricolin/magnum-cluster-api/commit/b1fb72b86c1e779a5ea59ddc4603230c0ffc70ec))
* Switch to kube-rs + avoid SSA ([#492](https://github.com/ricolin/magnum-cluster-api/issues/492)) ([41c969d](https://github.com/ricolin/magnum-cluster-api/commit/41c969d44cfc44a46d3948014a81de35ce60f214))
* Update bind address for k8s components ([#197](https://github.com/ricolin/magnum-cluster-api/issues/197)) ([4b1f5d8](https://github.com/ricolin/magnum-cluster-api/commit/4b1f5d840fb9f2158e7c7d8ebca6f1a86fb8569f))
* update handling vendor charts and add linters ([#413](https://github.com/ricolin/magnum-cluster-api/issues/413)) ([141d536](https://github.com/ricolin/magnum-cluster-api/commit/141d5361db0b90542bf3c0d8e9dd777833711253))
* upgrade capi version ([#299](https://github.com/ricolin/magnum-cluster-api/issues/299)) ([83535e7](https://github.com/ricolin/magnum-cluster-api/commit/83535e7405e1a1ef1ce0251694eec78882873838))
* Validate fixed_network and fixed_subnet existence ([46ac9ac](https://github.com/ricolin/magnum-cluster-api/commit/46ac9ac4ed288eac964af647d60d21d7865599c9))
* Validate flavors ([e438f4b](https://github.com/ricolin/magnum-cluster-api/commit/e438f4b490b16b7f296e9828f1100067845cafae))


### Bug Fixes

* add --non-interactive ([ce365c9](https://github.com/ricolin/magnum-cluster-api/commit/ce365c9c0bd8379f8e0e90bde60c54ee3b831d92))
* Add API status + misc status fixes ([#573](https://github.com/ricolin/magnum-cluster-api/issues/573)) ([c5b9e39](https://github.com/ricolin/magnum-cluster-api/commit/c5b9e39282846d2a552aa1200db6161abf9dff40))
* Add cacert in cloud config ([9fbdda6](https://github.com/ricolin/magnum-cluster-api/commit/9fbdda6f0fa95ab48a0c25baa4ef26e1c1cbea96))
* add containerd settings to workers ([ff708dd](https://github.com/ricolin/magnum-cluster-api/commit/ff708dd6e110a8ef8fb2d40348dd6dad35e057ae))
* add k8s-keystone-auth to image ([0c6ca67](https://github.com/ricolin/magnum-cluster-api/commit/0c6ca67d5a98f0d404d9dd28b3bfb9e443c937be))
* Add missing autoscaler chart manifests ([122f4b9](https://github.com/ricolin/magnum-cluster-api/commit/122f4b9d9d417a13150b692149533e7b6c81f2db))
* add missing env ([c5e6737](https://github.com/ricolin/magnum-cluster-api/commit/c5e6737b29b82351a592f3e80f060491bf51e330))
* Add missing equal sign for mounts ([#397](https://github.com/ricolin/magnum-cluster-api/issues/397)) ([2385424](https://github.com/ricolin/magnum-cluster-api/commit/2385424421808083597ae282402368ece4957459))
* add skips + breakout for DELETE_COMPLETE ([0e904b6](https://github.com/ricolin/magnum-cluster-api/commit/0e904b6e256f6cfb5ddf32816707368ea6738ac2))
* add tests to validate rewriting manifests ([c8944da](https://github.com/ricolin/magnum-cluster-api/commit/c8944dac31204a42ffc572f21b0c2581f71415a3))
* add unit tests for image loader + missing images ([#268](https://github.com/ricolin/magnum-cluster-api/issues/268)) ([5223b93](https://github.com/ricolin/magnum-cluster-api/commit/5223b93c19e22b4e7d01a4d44bf0e720ca966832))
* addd 1.26.2 images ([119b2c6](https://github.com/ricolin/magnum-cluster-api/commit/119b2c6fed91dc4ad82878007ed84f3bc77df6ad))
* address status changes for v1alpha7 ([5da7223](https://github.com/ricolin/magnum-cluster-api/commit/5da72233baa3af3935f4624bd67894c68f5aa338))
* allow configuring tls-cipher-suites ([#261](https://github.com/ricolin/magnum-cluster-api/issues/261)) ([d1b7ab5](https://github.com/ricolin/magnum-cluster-api/commit/d1b7ab5c2ea42eea35bfc87ede39ecd867ec94cf)), closes [#251](https://github.com/ricolin/magnum-cluster-api/issues/251)
* allow skipping node groups that are master or delete complete ([#415](https://github.com/ricolin/magnum-cluster-api/issues/415)) ([bd32dec](https://github.com/ricolin/magnum-cluster-api/commit/bd32dec463b0990175ba4517b4539ceb9cc75f18))
* avoid overriding api_address ([f7009cc](https://github.com/ricolin/magnum-cluster-api/commit/f7009ccd36756cbd40c622538c2831d0bff3004c))
* build generic wheels ([1f1273b](https://github.com/ricolin/magnum-cluster-api/commit/1f1273b043402ae406965b7bddf7831ece6e715a))
* bump capi ([ba2866d](https://github.com/ricolin/magnum-cluster-api/commit/ba2866defad25aac12f4055275251497311e4e22))
* clean-up old endpoint slices ([730743e](https://github.com/ricolin/magnum-cluster-api/commit/730743efe4ecd1233033fd7fa8119076981e4d01))
* continue, dont return in sync_kubeconfigs ([#582](https://github.com/ricolin/magnum-cluster-api/issues/582)) ([77e4f82](https://github.com/ricolin/magnum-cluster-api/commit/77e4f8285434f5c4380995cfd40e3bd89d7232a8))
* Convert Openstack volume type name to valid rfc1123 string ([7d0f316](https://github.com/ricolin/magnum-cluster-api/commit/7d0f316c85189f69ebe0787e3d24edb2b733501d))
* correct 1.25 autoscaler image ([52a756c](https://github.com/ricolin/magnum-cluster-api/commit/52a756c0c6d73d247251de4ee8324b3eecd969b8))
* correct dependency list ([65e2ea1](https://github.com/ricolin/magnum-cluster-api/commit/65e2ea1f5ff3e6ea8287b97f14af8111d84f5f4c))
* correct images ([df45fc4](https://github.com/ricolin/magnum-cluster-api/commit/df45fc4d2a89afde952eac9170a2f1b7f079fd43))
* **csi:** Use up-to-date provisioner name for Cinder CSI ([#295](https://github.com/ricolin/magnum-cluster-api/issues/295)) ([79a0ce2](https://github.com/ricolin/magnum-cluster-api/commit/79a0ce25633d8ea91a072ef1442aeb58db7e5111))
* deploy autoscaler right before the cluster creation completed ([#307](https://github.com/ricolin/magnum-cluster-api/issues/307)) ([a48ddef](https://github.com/ricolin/magnum-cluster-api/commit/a48ddef4bdd238c35ff967c2025898c0bec7c59f))
* **deps:** update rust crate kube to 0.99.0 ([#551](https://github.com/ricolin/magnum-cluster-api/issues/551)) ([9a0a206](https://github.com/ricolin/magnum-cluster-api/commit/9a0a20663edb784d555a89a2ea9197b714418bc0))
* **deps:** update rust crate once_cell to v1.21.1 ([#553](https://github.com/ricolin/magnum-cluster-api/issues/553)) ([89def56](https://github.com/ricolin/magnum-cluster-api/commit/89def56f1c2ba97b01f4f3e1b761424200a628a1))
* **deps:** update rust crate once_cell to v1.21.2 ([#621](https://github.com/ricolin/magnum-cluster-api/issues/621)) ([385b763](https://github.com/ricolin/magnum-cluster-api/commit/385b763e19fcc6559a73aabdc084877aa5d691c1))
* **deps:** update rust crate once_cell to v1.21.3 ([#625](https://github.com/ricolin/magnum-cluster-api/issues/625)) ([59ccc34](https://github.com/ricolin/magnum-cluster-api/commit/59ccc3441bc49f29291dc59dfdb2de090c9cd559))
* **deps:** update rust crate pyo3 to v0.24.1 [security] ([#627](https://github.com/ricolin/magnum-cluster-api/issues/627)) ([09650e9](https://github.com/ricolin/magnum-cluster-api/commit/09650e9389f0d82c65dbb5ae44a289044c2f10e7))
* **deps:** update rust crate pyo3-log to v0.12.2 ([#602](https://github.com/ricolin/magnum-cluster-api/issues/602)) ([86788ec](https://github.com/ricolin/magnum-cluster-api/commit/86788ecb306f9d39e66637bb8447cc2b2d1a2b8c))
* **deps:** update rust crate pyo3-log to v0.12.3 ([#626](https://github.com/ricolin/magnum-cluster-api/issues/626)) ([2a18243](https://github.com/ricolin/magnum-cluster-api/commit/2a182438f1051115bda3dec6e859539fa56d7eb1))
* **deps:** update rust crate quote to v1.0.40 ([#543](https://github.com/ricolin/magnum-cluster-api/issues/543)) ([430296b](https://github.com/ricolin/magnum-cluster-api/commit/430296b654c2a9188c4e91568a8492213e5c7c22))
* **deps:** update rust crate serde to v1.0.219 ([#559](https://github.com/ricolin/magnum-cluster-api/issues/559)) ([937d566](https://github.com/ricolin/magnum-cluster-api/commit/937d5663eaccdd0c3ec1aa31d9aa1281595d220f))
* **deps:** update rust crate tempfile to v3.19.0 ([#556](https://github.com/ricolin/magnum-cluster-api/issues/556)) ([069fc63](https://github.com/ricolin/magnum-cluster-api/commit/069fc63990dd1a7a900a31d358f1c72004c6d996))
* **deps:** update rust crate tempfile to v3.19.1 ([#575](https://github.com/ricolin/magnum-cluster-api/issues/575)) ([b4ae110](https://github.com/ricolin/magnum-cluster-api/commit/b4ae110ef6e9eb6683319b0254d1759d3e7e3ab9))
* **deps:** update rust crate tokio to v1.44.1 ([#557](https://github.com/ricolin/magnum-cluster-api/issues/557)) ([2c70a93](https://github.com/ricolin/magnum-cluster-api/commit/2c70a93ea4f59267acfe7bbc433d6095199fe44b))
* **deps:** update rust crate tokio to v1.44.2 ([#629](https://github.com/ricolin/magnum-cluster-api/issues/629)) ([952347b](https://github.com/ricolin/magnum-cluster-api/commit/952347b3351347fb77e34a93e0baa7bf9ca2a214))
* **deps:** update rust crate typed-builder to 0.21.0 ([#584](https://github.com/ricolin/magnum-cluster-api/issues/584)) ([102800f](https://github.com/ricolin/magnum-cluster-api/commit/102800fdacb6cb27401c9a51e9941fee230aa156))
* **deps:** update rust crate typed-builder to v0.20.1 ([#546](https://github.com/ricolin/magnum-cluster-api/issues/546)) ([94a8afc](https://github.com/ricolin/magnum-cluster-api/commit/94a8afc993a8e98e6f725fe03d68c8eac3421fd4))
* Do not upgrade helmrelease in pending status ([81bb06c](https://github.com/ricolin/magnum-cluster-api/commit/81bb06c054d4c7fa2f199171be6d58b2a5e16cf4))
* **doc:** Fix k8s version string ([b1f371c](https://github.com/ricolin/magnum-cluster-api/commit/b1f371cd36d8de041b50674006e856e5bed36a04))
* **doc:** nit picking for README ([848e016](https://github.com/ricolin/magnum-cluster-api/commit/848e016094aa21e767d03f08bbc8f1d05adb6a18))
* Double-up permissions for release ([5b2aa1a](https://github.com/ricolin/magnum-cluster-api/commit/5b2aa1a93e5dfccc227cdfb1fa4fbedeba2fdbd3))
* Drop MachineDeployment annotation workaround [#142](https://github.com/ricolin/magnum-cluster-api/issues/142) ([e3981ed](https://github.com/ricolin/magnum-cluster-api/commit/e3981ed1b7790b19343d326e20bab43e8f8b507f))
* enable deleting missing machine deployment ([#640](https://github.com/ricolin/magnum-cluster-api/issues/640)) ([19b9c56](https://github.com/ricolin/magnum-cluster-api/commit/19b9c56191e9a2ca988abd4e2b110df6e15ef86f))
* fix audit log enabled clusters ([#276](https://github.com/ricolin/magnum-cluster-api/issues/276)) ([ef1a1ff](https://github.com/ricolin/magnum-cluster-api/commit/ef1a1ffb71cb5584466d201c4d25d49bb0cffa1e))
* fix CloudConfigSecret deletion ([#513](https://github.com/ricolin/magnum-cluster-api/issues/513)) ([1990e1c](https://github.com/ricolin/magnum-cluster-api/commit/1990e1c6d09056263ec6a6c1bd086efb70c3e0f6))
* fix cluster status when update done ([#322](https://github.com/ricolin/magnum-cluster-api/issues/322)) ([9c237d1](https://github.com/ricolin/magnum-cluster-api/commit/9c237d1f37f94ac922efe22fe65e6aac74a1234c))
* fix jsonpatch for preKubeadmCommands ([#331](https://github.com/ricolin/magnum-cluster-api/issues/331)) ([6fcf823](https://github.com/ricolin/magnum-cluster-api/commit/6fcf823e8e71a807d90f91db5b59dd2a748daad0))
* Fix manila csi config ([#254](https://github.com/ricolin/magnum-cluster-api/issues/254)) ([867efdb](https://github.com/ricolin/magnum-cluster-api/commit/867efdb40b646d472366e21db8187ad4d7f2f216))
* Fix the certificate deletion ([17c243a](https://github.com/ricolin/magnum-cluster-api/commit/17c243a906cdbf14e8fe74f60f3f5f8166eb3c82))
* fix typo in basic delete of resource classes ([#511](https://github.com/ricolin/magnum-cluster-api/issues/511)) ([e6959a3](https://github.com/ricolin/magnum-cluster-api/commit/e6959a333169e9768fca236bbd926c1615032371))
* Fix typo in developer guide doc ([ff59cbb](https://github.com/ricolin/magnum-cluster-api/commit/ff59cbb4a086a7bf63e01927915ca72438ab6351))
* fix unit tests for sync and disable image build job in CI ([#367](https://github.com/ricolin/magnum-cluster-api/issues/367)) ([668d4f9](https://github.com/ricolin/magnum-cluster-api/commit/668d4f9a62e5370408199b759eb8a7526ce06082))
* force a cluster upgrade all the time ([#382](https://github.com/ricolin/magnum-cluster-api/issues/382)) ([436bcf2](https://github.com/ricolin/magnum-cluster-api/commit/436bcf26eb3fb30efef67b01a8ad400ca1bcce03))
* force scale-up cluster nodegroup when node_count &lt; min_node_count ([#528](https://github.com/ricolin/magnum-cluster-api/issues/528)) ([828c20e](https://github.com/ricolin/magnum-cluster-api/commit/828c20ef26a912836eb004b2651f4ba948bb551c))
* **helm:** make upgrades more robust ([d42696d](https://github.com/ricolin/magnum-cluster-api/commit/d42696d70f353a8aa5ac42506d92db03ad93cfaf))
* **helm:** skip deploying autoscaler unnecessarily ([6299ec5](https://github.com/ricolin/magnum-cluster-api/commit/6299ec55c499ac62e0bb9e9402d471c73fc9109f))
* **helm:** upgrade path ([5b9bbca](https://github.com/ricolin/magnum-cluster-api/commit/5b9bbcad90c9530cd76bdba850c0e455efe027bd))
* Improve node group tracking ([#388](https://github.com/ricolin/magnum-cluster-api/issues/388)) ([a0fbfdd](https://github.com/ricolin/magnum-cluster-api/commit/a0fbfddfadadad736232713331665737f468e9b9))
* include nodegroups in COMPLETE status in cluster update job ([#427](https://github.com/ricolin/magnum-cluster-api/issues/427)) ([b50b6dc](https://github.com/ricolin/magnum-cluster-api/commit/b50b6dc83a8f49f01aacf6fec99b670c1316a620))
* incorrect case ([ab16448](https://github.com/ricolin/magnum-cluster-api/commit/ab16448e99198510b40e989ace2aaa4fc0c61a8b))
* **mhc:** increase max unhealthy to 80% ([700a19c](https://github.com/ricolin/magnum-cluster-api/commit/700a19cc52bbf6a62983b3fbb6395eea5b2fa3b5))
* name replacement for new repo ([0eaeeba](https://github.com/ricolin/magnum-cluster-api/commit/0eaeeba06bf3161260cb139a5da45a4755dcb3f0))
* only set replicas if auto scaling is disabled ([a6a4bf4](https://github.com/ricolin/magnum-cluster-api/commit/a6a4bf4b0a606a71b424cabebcbfd992d582e962))
* optimize + improve registry builds ([eeb61d2](https://github.com/ricolin/magnum-cluster-api/commit/eeb61d2441161eb6fe1f8c5e26b1a1c6fd2d2f09))
* **ovn:** use octavia_provider for api lb ([#360](https://github.com/ricolin/magnum-cluster-api/issues/360)) ([9b0ec1e](https://github.com/ricolin/magnum-cluster-api/commit/9b0ec1eecd9a1ae067b4c046bb92c569d9c4d121))
* refactor to using handlers with context ([9e5cb2d](https://github.com/ricolin/magnum-cluster-api/commit/9e5cb2ded67aac22dcb3512c92b74bf07a96841a))
* remove deleted nodegroups ([66c650f](https://github.com/ricolin/magnum-cluster-api/commit/66c650faf481058261e2befe917bfc1d289f8a39))
* remove tracebacks for missing objects ([a148d4f](https://github.com/ricolin/magnum-cluster-api/commit/a148d4f89744b01c6e29c4f1ecbd723230f6b21c)), closes [#68](https://github.com/ricolin/magnum-cluster-api/issues/68)
* replace $PROJECT_ID in the template ([#525](https://github.com/ricolin/magnum-cluster-api/issues/525)) ([70835e4](https://github.com/ricolin/magnum-cluster-api/commit/70835e4c0e25aa0ed82fc45a7d2410a6da810315))
* replace the repository name ([bda20a2](https://github.com/ricolin/magnum-cluster-api/commit/bda20a23d1845f022091029e0ed10598e07c1a94))
* respect `availability_zone` for control plane ([#313](https://github.com/ricolin/magnum-cluster-api/issues/313)) ([6803bd3](https://github.com/ricolin/magnum-cluster-api/commit/6803bd3f705188b476df28f4ee2bb76bedbf3541))
* return helm output ([95c32a7](https://github.com/ricolin/magnum-cluster-api/commit/95c32a79bdb1630365b951176e1c6c9fbc50d93c))
* Run apply CRS on upgrade ([#617](https://github.com/ricolin/magnum-cluster-api/issues/617)) ([e37df66](https://github.com/ricolin/magnum-cluster-api/commit/e37df66de12a06dc81a968c227216b196e712520))
* Run maturin publish ([#498](https://github.com/ricolin/magnum-cluster-api/issues/498)) ([95f4c71](https://github.com/ricolin/magnum-cluster-api/commit/95f4c71270a436cc1ab97df77f0293c8109f941f))
* Set MachineDeployment replicas as min node count when autoscale enabled ([3cc9b19](https://github.com/ricolin/magnum-cluster-api/commit/3cc9b195d3964491983063a669af60037490dd63))
* Set nodegroup labels always ([5d5afa5](https://github.com/ricolin/magnum-cluster-api/commit/5d5afa55331df5dbdfa970d4fc142d34e1163a86))
* set nodeVolumeDetachTimeout property for machines ([c52f3e7](https://github.com/ricolin/magnum-cluster-api/commit/c52f3e7d90d5a18852d1c189f6c3095395f4ac88))
* Set the cluster status as in_progress at the end of update_nodegroup handler ([9d3312c](https://github.com/ricolin/magnum-cluster-api/commit/9d3312c3e542b5764b8643453cd0efa052efd082))
* Skip delete_cluster when stack_id is none ([cabd872](https://github.com/ricolin/magnum-cluster-api/commit/cabd8729b64d8a716f8b970a1d91234c279a03b4)), closes [#126](https://github.com/ricolin/magnum-cluster-api/issues/126)
* solve black conflict ([e17ca40](https://github.com/ricolin/magnum-cluster-api/commit/e17ca4088f1abd4c5ee6b7ee481f2117fadf5057))
* Solve build problems ([#506](https://github.com/ricolin/magnum-cluster-api/issues/506)) ([00110bd](https://github.com/ricolin/magnum-cluster-api/commit/00110bdf2bb87199ae645e898e11e28d134dddf5))
* solve cluster delete sync ([53048c8](https://github.com/ricolin/magnum-cluster-api/commit/53048c8de81cbef0e643aea94dd62e23d222a455))
* solve lock issues + extra unit tests ([#343](https://github.com/ricolin/magnum-cluster-api/issues/343)) ([3438204](https://github.com/ricolin/magnum-cluster-api/commit/3438204a0787c5c84c1d6d5d496d8949ca73c2d5))
* solve proxied service cleanup ([476d1f7](https://github.com/ricolin/magnum-cluster-api/commit/476d1f745b4588303cf52f48cddf07f2c11fdba0))
* solve proxy issue with ovn ([#302](https://github.com/ricolin/magnum-cluster-api/issues/302)) ([5b4bad4](https://github.com/ricolin/magnum-cluster-api/commit/5b4bad49415d6daa5df7399d77d364c8839d7a87))
* solve race condition for stack_id ([43474f1](https://github.com/ricolin/magnum-cluster-api/commit/43474f1c81cc1268afdac4f4f21681ded28fcfa4))
* Solve trusted publishing ([f7f665c](https://github.com/ricolin/magnum-cluster-api/commit/f7f665c76cc35fa2fed8048c131ca47c5d9e146e))
* stop adding cluster name to node name ([0024683](https://github.com/ricolin/magnum-cluster-api/commit/002468379a0ffd8cc20490477e46ac43bacb6478)), closes [#96](https://github.com/ricolin/magnum-cluster-api/issues/96)
* stop unexpected rollouts ([#324](https://github.com/ricolin/magnum-cluster-api/issues/324)) ([78f8a02](https://github.com/ricolin/magnum-cluster-api/commit/78f8a02691b5dc25dd82d0747d8050bf85b9ede4))
* Stop waiting on CAPI in API ([#393](https://github.com/ricolin/magnum-cluster-api/issues/393)) ([024a3d9](https://github.com/ricolin/magnum-cluster-api/commit/024a3d93cc3689d1cea7281dad3270be8b4d22c5))
* Switch CCM to seperate CRS ([#604](https://github.com/ricolin/magnum-cluster-api/issues/604)) ([e0a3262](https://github.com/ricolin/magnum-cluster-api/commit/e0a326201dace41d7d95c56a2c34dcf89cc5072d))
* test image loader ([7e7b30c](https://github.com/ricolin/magnum-cluster-api/commit/7e7b30c57f8cd5ad16bf71d84fc6a2c99cb5e7c7))
* Update cluster-autoscaler chart version to support k8s 1.27 ([#192](https://github.com/ricolin/magnum-cluster-api/issues/192)) ([883968a](https://github.com/ricolin/magnum-cluster-api/commit/883968a555e31039fe014522621f7eb50c1c261e))
* **upgrades:** set correct cluster_template_id ([#349](https://github.com/ricolin/magnum-cluster-api/issues/349)) ([49dc0c9](https://github.com/ricolin/magnum-cluster-api/commit/49dc0c980d1f0c84032ab1f3517f0081afc76a38))
* use 20.04 by default ([0af2de3](https://github.com/ricolin/magnum-cluster-api/commit/0af2de3c5a4ce4600bcc28be944edef19a887dfd))
* use api from arg ([386eead](https://github.com/ricolin/magnum-cluster-api/commit/386eeadd6614cb30d108ba42fb3456da226d5f34))
* use apply patch strategy for kube api resource update ([904abff](https://github.com/ricolin/magnum-cluster-api/commit/904abff90ec5c0b89c25f1f8f3912abd3e7a049e))
* use azure dns + fix subnet mismatch ([16d75c6](https://github.com/ricolin/magnum-cluster-api/commit/16d75c6be0bc7690b9cade2d1198dcf80b43d1fa))
* use capi to determine health ([#226](https://github.com/ricolin/magnum-cluster-api/issues/226)) ([d599617](https://github.com/ricolin/magnum-cluster-api/commit/d599617fcc9620d989446b3a8e9875a958b1c725))
* use correct cloud_provider_tag ([#532](https://github.com/ricolin/magnum-cluster-api/issues/532)) ([ab5cb64](https://github.com/ricolin/magnum-cluster-api/commit/ab5cb64bbd86d7eace43b524b6fd140da29d5a36))
* use correct sandbox_image ([80d74d2](https://github.com/ricolin/magnum-cluster-api/commit/80d74d26d5d341c0042a794a2f5ab7151952442c))
* use get method to get obj component ([#376](https://github.com/ricolin/magnum-cluster-api/issues/376)) ([c259a71](https://github.com/ricolin/magnum-cluster-api/commit/c259a7142cdc90d68b453d286f1cc504722c3ee3)), closes [#368](https://github.com/ricolin/magnum-cluster-api/issues/368)
* use locking for status update ([#318](https://github.com/ricolin/magnum-cluster-api/issues/318)) ([dcceec4](https://github.com/ricolin/magnum-cluster-api/commit/dcceec4ed017914c94b8bbe011cde4654c503793))
* use new registry + 1.26.2 images ([b6c814f](https://github.com/ricolin/magnum-cluster-api/commit/b6c814f503b939ae48ed97a8b86f003f7b9346e1))
* Use pinned GitHub action ([03c5db6](https://github.com/ricolin/magnum-cluster-api/commit/03c5db6fee97909ff2061c8e5d89bf787c4b52a2))
* Use PyO3/maturin-action ([#496](https://github.com/ricolin/magnum-cluster-api/issues/496)) ([5d3b5c0](https://github.com/ricolin/magnum-cluster-api/commit/5d3b5c035c90ed8cf98512f45021ae5a539c1a56))
* Wait until observedGeneration of the capi cluster is increased in cluster upgrade ([58b6325](https://github.com/ricolin/magnum-cluster-api/commit/58b632569496961ac9ffb09c00e043627791bb6e)), closes [#57](https://github.com/ricolin/magnum-cluster-api/issues/57)


### Documentation

* add dashboard docs ([2ae4adb](https://github.com/ricolin/magnum-cluster-api/commit/2ae4adb4f178a340b4f922f7d50cb100d6a5fcd5))
* add etcd_volume_{size,type} docs ([3f1a636](https://github.com/ricolin/magnum-cluster-api/commit/3f1a636cb70f5a6aa41178945b71cb18e2729661))
* add links to new images ([4fd698f](https://github.com/ricolin/magnum-cluster-api/commit/4fd698f21a38df58ceb98fda12f673ea7114efbd))
* added basic troubleshooting docs ([f2f2983](https://github.com/ricolin/magnum-cluster-api/commit/f2f2983c059334f18b94da272a99faa9efd2f46d))
* refactor into tabs ([8c0cbbb](https://github.com/ricolin/magnum-cluster-api/commit/8c0cbbbb310bfaff01509585c2b0036631d8a065))
* remove broken 1.26.2 images ([42f8a5f](https://github.com/ricolin/magnum-cluster-api/commit/42f8a5f9a5221b8b7609c9524c1a079ac919d6b8))


### Miscellaneous Chores

* release 0.11.1 ([36b9319](https://github.com/ricolin/magnum-cluster-api/commit/36b931918b28ae4db526550290ae7a4201dff0d8))
* release 0.11.2 ([9d10552](https://github.com/ricolin/magnum-cluster-api/commit/9d10552125494bcf3bffafea35429f6c6439b1f0))
* release 0.15.0 ([50121a6](https://github.com/ricolin/magnum-cluster-api/commit/50121a607fa1ab29a269d86b105c7a1c1a6e3611))
* release 0.15.1 ([0f89859](https://github.com/ricolin/magnum-cluster-api/commit/0f898598702f0de98d6ef47829f39205c2cea4df))
* release 0.21.0 ([7906dfa](https://github.com/ricolin/magnum-cluster-api/commit/7906dfab149fb58f7abed60701f1838d93caeeff))
* release 0.21.1 ([8a16cf9](https://github.com/ricolin/magnum-cluster-api/commit/8a16cf9330a075025d726c670746ae604a0c3a60))
* release 0.23.0 ([8110c75](https://github.com/ricolin/magnum-cluster-api/commit/8110c753e42d66baa353b3e31738bb71dd0dded2))
* release 0.24.0 ([6766b02](https://github.com/ricolin/magnum-cluster-api/commit/6766b02ebfb98d18cb523ab5921673f7bc43370a))
* release 0.24.1 ([cfb4f64](https://github.com/ricolin/magnum-cluster-api/commit/cfb4f6443cbf5918389268cfb6dd6f125a458505))
* release 0.24.2 ([36f95a2](https://github.com/ricolin/magnum-cluster-api/commit/36f95a2142792fb262eb99f66df5c5d4cc0ede12))
* release 0.26.3 ([7ef0932](https://github.com/ricolin/magnum-cluster-api/commit/7ef0932b4cdaafb10e71f73a3e01c6d4c945efb7))
